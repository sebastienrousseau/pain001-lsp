#!/usr/bin/env python3
"""Verify that the pain001-lsp package version is in lockstep everywhere.

Single source of truth: ``pain001_lsp.__version__``. This script reads
...
def _package_version() -> str:
    ...
    import pain001_lsp  # noqa: E402  (path-dependent import)

    return pain001_lsp.__version__
...
def main() -> int:
    ...
    print(f"  pain001_lsp.__version__   = {pkg}")
