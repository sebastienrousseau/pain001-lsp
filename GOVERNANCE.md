...
# pain001-lsp Governance

This document describes how pain001-lsp is run, how decisions are made,
...
pain001-lsp is the Language Server Protocol surface for the
[`pain001`](https://github.com/sebastienrousseau/pain001) ISO 20022
library. It surfaces diagnostics, completion, hover, and code actions
in any LSP-capable editor when authoring payment-data JSON or CSV files.
Changes are weighed against that scope: correctness, security, and
...
Releases follow [`RELEASING.md`](RELEASING.md). pain001-lsp tracks
[`pain001`](https://github.com/sebastienrousseau/pain001) version-for-
version: when pain001 cuts `0.0.X`, pain001-lsp ships a matching
...
pain001-lsp today has **one** maintainer, which is a real risk for a
